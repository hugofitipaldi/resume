...
* `genderAPI`: R package to access genderapi.io and predict a gender by name.
* `affiliation`: Named entity recognition package to extract affiliation locations from co-authorship lists in scientific publications.
